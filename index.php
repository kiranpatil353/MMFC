<?php
	/*
  Plugin Name: Multiple Map Marker Filter
  Description: Multiple map marker and filter plugin is useful to display maps on your website posts and pages using shortcode [map_filter], With fully customized icons and settings.
  Version: 1.0
